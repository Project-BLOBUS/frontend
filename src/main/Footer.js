        ...
        <footer className="w-full sm:w-[90%] lg:w-[70.6%] mx-auto mt-2 py-4 bg-[linear-gradient(45deg,_#6E00FF,_#DB0153,#0130BC)] text-white">
            <div className="flex flex-col sm:flex-row justify-between items-center sm:space-y-0 space-y-4 sm:space-x-6">
                ...
                <div className="flex sm:flex-row flex-col sm:space-x-6 sm:mt-0 mt-4 sm:text-left text-center">
                    <Link to="/#" className="hover:text-gray-300 transition duration-500">About Us</Link>
                    <Link to="/#" className="hover:text-gray-300 transition duration-500">Contact</Link>
                    <Link to="/#" className="hover:text-gray-300 transition duration-500">Privacy Policy</Link>
                    <Link to="/#" className="hover:text-gray-300 transition duration-500">Terms of Service</Link>
                </div>
