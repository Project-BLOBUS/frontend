    ...
    <div>
      ...
      <div className="w-[70%] h-[600px] ml-[15%] mt-[1%] ">
        ...
        <div className=" h-[80%] mt-[2%] mr-[8%]">
          <p className="w-[170px] h-[50px] ml-[45%] mt-[%] text-5xl font-bold text-transparent bg-[linear-gradient(75deg,_#0130BC,_#DB0153)] bg-clip-text">
            BLoBus
          </p>

          <p className="text-xl font-bold w-[670px] p-2 bg-[linear-gradient(75deg,_#0130BC,_#DB0153)] ml-[22%] mt-[2%] rounded-full text-white">
            부산을 중심으로 세계와 청년이 하나로 연결하는 정보 통합 플랫폼 구축
          </p>

          <p className="w-[700px]  ml-[21%] text-md font-bold text-gray-600 text-center mt-4">
            BLoBus는 부산 청년들이 필요한 정보와 정책을 한곳에서 직관적이고 효율적으로 제공하는 통합 플랫폼으로, 청년들이 지역에 정착할수 있는 기반을 마련
          </p>

          <div className=" flex space-x-20 pl-[14%] w-[100%] h-[60%]">
              ...
              <nav className="w-[223px] h-[240px] mt-4 p-5 border-2 border-[#D8B7DD] rounded-[25px] text-lg font-bold  ">
                 <p className="mt-[-10px]"> Two Chapter</p> 
                <p className="bg-[#D8B7DD] text-[15px] w-[224px] h-[190px] mt-[10px] ml-[-22px] rounded-b-[25px] p-4 text-slate-700">이를 통해 부산이 단순히 머무르는 곳이 아닌, 청년들에게 매력적인 미래를 설계할 수 있는 도시로 거듭날 수 있도록 돕는것을 목표</p>
              </nav>
      ...
      {/* "BLoBus의 설명" 카드 */}
      <div className="w-[200px] h-[200px] rounded-[25px] ml-[1%] mt-[-31%] bg-[linear-gradient(75deg,_#0130BC,_#DB0153)]">
        <p className="flex justify-center items-center pt-4 text-2xl font-bold text-white">
          BLoBus 소개
        </p>

        <div className="w-[200px] h-[170px] rounded-[25px] bg-white font-bold mt-[20px] p-4 space-y-6 border-2">
