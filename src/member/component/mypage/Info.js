    ...
    <>
      ...
      <div className="w-full text-base text-center font-bold flex flex-col justify-center items-center">
        ...
        <div className="w-full py-2 flex justify-center items-center space-x-2">
          <div className="bg-white w-1/3 py-[3.825rem] border-2 border-gray-300 rounded shadow-xl flex flex-col justify-center items-center">
          ...
          <div className="w-2/3 flex flex-col justify-center items-center space-y-2">
            <div className="bg-white w-full h-2/3 border-2 border-gray-300 rounded shadow-xl flex flex-col justify-center items-center">
            ...
            <div className="bg-white w-full h-1/3 border-2 border-gray-300 rounded shadow-xl flex flex-col justify-center items-center">
              <div className="w-full p-2 text-xl border-b-2 border-yellow-500 text-left">
                연락처 정보
              </div>
              {makeRead(
        ...
        <div className="w-full py-2 flex justify-end items-center space-x-0">
          {makeBtn2("수정", () => {
            setLoading(true);
            setBtnType("수정");
            setModal(true);
